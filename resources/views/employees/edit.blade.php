        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs edit-nav-styling">
              ...
              <li id="locationTab" class=""><a href="#tab_documentDetailsTab" data-toggle="tab">Location</a></li>
						  ...
						  <div class="row field-changes-below">
							...
							<!--<div class="row field-changes-below">
			                    ...
			                    <div class="col-md-8 basic-input-right">
			                      ...
			                      <input type="text" class="form-control input-sm basic-detail-input-style text-capitalize" id="leavePool_maternity" name="leavePool_maternity" placeholder="Please Enter Sick Leave pool" value="{{@$data['leave_details']->balance_maternity_leave}}" >
							...
							<!--<div class="row field-changes-below">
			                    ...
			                    <div class="col-md-8 basic-input-right">
			                      ...
			                      <input type="text" class="form-control input-sm basic-detail-input-style text-capitalize" id="leavePool_paternity" name="leavePool_paternity" placeholder="Please Enter Sick Leave pool" value="{{@$data['leave_details']->balance_paternity_leave}}" >
