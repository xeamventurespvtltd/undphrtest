        ...
        <div class="col-sm-12">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body no-padding">
              ...
              <div class="table-responsive mailbox-notifications">
                ...
                @if(!$notifications->isEmpty())    
                  ...
                  <tr>
                    ...
                    <td class="mailbox-name">{{@$notification->sender->employee->fullname}}</td>
                    ...
                    <td class="mailbox-date">{{date("d/m/Y h:i:s A",strtotime(@$notification->created_at))}}</td>
                  </tr>
                  @endforeach
                @else
                  <span class="text-info">&nbsp;{{"No notifications."}}</span>
                @endif  
  ...
  <script type="text/javascript">
    ...
    $(".deleteBtn").on('click',function(){
      ...
      if(selectedIds.length > 0){
        ...
        if (!confirm("Are you sure you want to delete these notification(s)?")) {
          return false; 
        }else{
          $.ajax({
            type: 'POST',
            url: "{{url('employees/delete-notifications')}}",
