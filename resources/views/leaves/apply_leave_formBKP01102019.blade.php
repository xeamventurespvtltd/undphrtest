  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="row leave-type2">
        ...
        <div class="col-sm-6 col-xs-6 leaves5">
          <div class="panel panel-primary leave-type-sectn">
            <div class="panel-heading leave-heading">Comp Off Leaves:
              <span class="label label-primary">{{@$data['probation_data']->compensatory_count}}</span>
            </div>
            <!-- <div class="panel-body leave-content">
            ...
            <form id="leaveForm" action="{{ url('leaves/create-leave-application') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="box-body form-sidechange form-decor">
                ...
                <div class="form-group">
                  <div class="row">
                      ...
                      <div class="col-md-10 col-sm-9 col-xs-9 leave-input-box">
                          <select class="form-control basic-detail-input-style apply-leave-input" name="leaveTypeId" id="leaveTypeId">
                          @if(!$data['leave_types']->isEmpty())
                            @if(@$data['probation_data']->leaves_left + @$data['probation_data']->compensatory_count > 0)
                              ...
                              <option value="{{$leave_type->id}}" @if($data['gender'] == "Male" && $leave_type->name == 'Maternity Leave'){{"disabled"}}@endif>{{$leave_type->name}}</option>
                              @endforeach
                            @else
                ...
                <div class="row">
                  ...
                  <div class="col-md-10 leave-file-input">
                ...
                <div class="showTimes bootstrap-timepicker">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 leave-label-tr">
                      <div class="form-group">
                          <div class="row">
                              <div class="col-md-4 col-sm-3 col-xs-3 leave-label-box">
                ...
                <div class="form-group showRadio apply-leave-time-section">
                    <div class="row">
                        ...
                        <div class="col-md-10 col-sm-9 col-xs-9 leave-file-input">
                ...
                <div class="form-group">
                  <div class="row">
                      ...
                      <div class="col-md-10 col-sm-9 col-xs-9 leave-input-box">
                          <select class="form-control basic-detail-input-style apply-leave-input" name="countryId" id="countryId">
                ...
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-2 col-sm-3 col-xs-3 leave-label-box">
                          <label class="apply-leave-label">Absence Contact Number<span style="color: red">*</span></label>
                      </div>
                      <div class="col-md-2 col-sm-3 col-xs-3 leave-absence-left">
                          <select class="form-control basic-detail-input-style apply-leave-input" name="mobileStdId">
                              @if(!$data['countries']->isEmpty())
                              @foreach($data['countries'] as $country)  
                      ...
                      <div class="col-md-8 col-sm-6 col-xs-6 leave-absence-right">
                ...
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-2 col-sm-3 col-xs-3 leave-label-box">
                          <label class="apply-leave-label">Replacement Person Department<span style="color: red">*</span></label>
                      </div>
                      <div class="col-md-8 col-sm-7 col-xs-7 leave-input-box">
                ...
                <div class="form-group">
                  <div class="row">
                      ...
                      <div class="col-md-8 col-sm-7 col-xs-7 leave-input-box">
                          <select class="form-control basic-detail-input-style apply-leave-input" name="replacement" id="replacement">
                          </select>
                      </div>
                      <div class="col-md-2 col-sm-2 col-xs-2 leave-input-box">
                ...
                <div class="form-group">
                  <div class="row">
                      ...
                      <div class="col-md-10 col-sm-9 col-xs-9 leave-duties">
  ...
  <script type="text/javascript">
   ...
   //Date picker
    ...
    $(".secondLeaveType").click(function(){
      var allowFormSubmit = {time: 1, date: 1, maternity: 1};
