        ...
        <!--<div class="col-sm-4 col-xs-4 leaves1">
          <div class="panel panel-danger leave-type-sectn">
            <div class="panel-heading leave-heading">Balance Casual Leave:
              <span class="label label-danger">{{@$data['leave_detail']->balance_casual_leave}}</span>
            </div>
        ...
        <div class="col-sm-4 col-xs-4 leaves2">
          <div class="panel panel-success leave-type-sectn">
            <div class="panel-heading leave-heading">Balance Sick Leaves:
              <span class="label label-success">{{@$data['leave_detail']->balance_sick_leave}}</span>
            </div>
        ...
        <div class="col-sm-3 col-xs-3 leaves1">
          <div class="panel panel-danger leave-type-sectn">
            <div class="panel-heading leave-heading">Paternity Leave:
              <!--<span class="label label-info">{{@$data['leave_detail']->balance_paternity_leave}}</span>-->
         ...
         <div class="col-sm-3 col-xs-3 leaves3">
          <div class="panel panel-warning leave-type-sectn">
            <div class="panel-heading leave-heading">Maternity Leave:
              <!--<span class="label label-warning">{{@$data['leave_detail']->balance_maternity_leave}}</span>-->
        <span class="label label-warning">As per Government of India</span>
        ...
        <div class="col-sm-3 col-xs-3 leaves2">
          <div class="panel panel-success leave-type-sectn">
            <div class="panel-heading leave-heading">Accumulated Casual Leave:
              <span class="label label-info">{{@$data['leave_detail']->accumalated_casual_leave}}</span>
            </div>
            <!-- <div class="panel-body leave-content"> -->
        ...
        <div class="col-sm-3 col-xs-3 leaves3">
          <div class="panel panel-warning leave-type-sectn">
           <div class="panel-heading leave-heading">Accumulated Sick Leave:
              <span class="label label-info">{{@$data['leave_detail']->accumalated_sick_leave}}</span>
            </div>
            <!-- <div class="panel-body leave-content">
        ...
        <div class="col-sm-3 col-xs-3 leaves1">
          <div class="panel panel-danger leave-type-sectn">
            <div class="panel-heading leave-heading">Paid Casual Leave Taken:
              <span class="label label-info">{{@$data['leave_detail']->paid_casual}}</span>
            </div>
            <!-- <div class="panel-body leave-content"> -->
        ...
        <div class="col-sm-3 col-xs-3 leaves1">
          <div class="panel panel-danger leave-type-sectn">
            <div class="panel-heading leave-heading">Paid Sick Leave Taken:
              <span class="label label-info">{{@$data['leave_detail']->paid_sick}}</span>
            </div>
            <!-- <div class="panel-body leave-content"> -->
         ...
         <div class="col-sm-3 col-xs-3 leaves2">
          <div class="panel panel-success leave-type-sectn">
            <div class="panel-heading leave-heading">UnPaid Leave Taken:
              <span class="label label-info">{{@$data['leave_detail']->unpaid_sick + @$data['leave_detail']->unpaid_casual}}</span>
            </div>
            <!-- <div class="panel-body leave-content"> -->
