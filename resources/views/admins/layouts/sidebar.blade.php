    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li class=""><a title="Download mediclaim policy" href="{{ asset('public/uploads/documents/BHARTI').'/bharti Axa bill GAvi No 1258 (1).pdf' }}"  target=”_blank”><i class="fa fa-circle-o text-red"></i>Mediclaim(3L) 3</a></li>
