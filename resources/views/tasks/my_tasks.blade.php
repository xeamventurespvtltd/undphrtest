...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-12">
            <div class="no-print">
              <div class="callout callout-success" style="margin-bottom: 5px!important;">
                ...
                Before marking a task as in-progress please ensure that you do not want anything to be edited in the task. If you want the task to be edited, then please discuss with the task creator from the task details page or in person. Mark it as in-progress after it has been edited.
              </div>
            </div>
            ...
            <form id="viewTasksList" method="GET">
              ...
              <div class="row select-detail-below">
                  ...
                  <div class="col-md-2 attendance-column2">
                    ...
                    <select class="form-control input-sm basic-detail-input-style" name="my_status" id="my_status">
      ...
      <div class="taskActionBar">
        ...
        <div class="taskActionBar2">
      		<select name="" id="change-task-status" class="form-control input-sm basic-detail-input-style">
      			<option value="Inprogress">Mark as Inprogress</option>
    ...
    <!-- </form> -->
        ...
        @foreach($tasks as $task)
            ...
            <td><em><strong>{{$task->status}}</strong></em></td>
              ...
              <td class="Working_on_it" style="padding: 0px;"><a href="javascript:void(0)" class="task-updates" data-taskid="{{$task->id}}" data-tasktitle="{{$task->title}}"><div style="padding: 28px 0px;">Inprogress
              @if($task->task_updates_count)
    ...
    <!-- /.content --> 
    <div class="modal fade" id="task-updates-modal">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title">Add Task Updates</h4>
            </div>
            <div class="modal-body">
              <form id="addtaskUpdate" action="{{ url('tasks/save-task-update') }}" method="POST">
                {{ csrf_field() }}
                  <div class="box-body">
                    
                    <div class="form-group">
                      <label for="on_date">For Date</label>
                      <input type="text" class="form-control" name="on_date" value="{{date('d/m/Y')}}" readonly>
                    </div>
                    ...
                    <input type="hidden" name="on_date" value="{{date('Y-m-d')}}">

                    <div class="form-group">
                      <label for="task_comment">Update (minimum 25 characters)</label>
                       <textarea class="form-control" rows="7" name="task_comment" id="task_comment"></textarea>
                    </div>
                  ...
                  <div class="box-footer">
                    <button type="submit" class="btn btn-primary" id="addtaskUpdateFormSubmit">Submit</button>
                  </div>
            </form>
            </div>
    ...
    <div class="modal fade" id="addCommentModal">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="addCommentForm" action="{{ url('tasks/change-my-task-status') }}" method="POST">
                {{ csrf_field() }}
                  <div class="box-body">
...
var defMyStatus = "{{@$my_status}}";
if(defMyStatus){
  $("#my_status").val(defMyStatus);
}
...
$(document).ready(function(){
  ...
  $(".task-updates").on('click',function(){
    var task_id = $(this).data("taskid");
    var task_title = $(this).data("tasktitle");
    $("#task_id").val(task_id);
    $("#task_title").val(task_title);
    $("#task-updates-modal").modal('show');
  });
});
