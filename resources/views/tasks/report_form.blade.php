...
<!-- Content Wrapper. Contains page content -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb breadcrumb-task-change">
      ...
      <div class="row">
          <div class="col-sm-12">
           <div class="box box-primary">
            ...
            <div class="box-header with-border task-form-title-bg">
            ...
            <form id="taskReportForm" action="{{ url('tasks/create-task-report') }}" method="POST">
              {{ csrf_field() }}
              <div class="box-body form-sidechange form-decor">
                ...
                <div class="row showDates">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-4 col-sm-3 col-xs-3 task-label-box">
                                    <label for="inputEmail3" class="control-label holiday-label">From Date</label>
                                </div>
                                <div class="col-md-8 col-sm-9 col-xs-9 task-input-box-right">
                                    <div class="input-group basic-detail-input-style">
                                      <input type="text" class="form-control selectDate apply-task-input" id="fromDate" name="fromDate" placeholder="Select a date" readonly>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-sm-9 col-xs-9">
                                    <div class="input-group basic-detail-input-style">
                                      <input type="text" class="form-control selectDate apply-task-input" id="toDate" name="toDate" placeholder="Select a date" readonly>
                ...
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-2 col-sm-3 col-xs-3 task-label-box">
                          <label class="apply-task-label">Project</label>
                      </div>
                      <div class="col-md-10 col-sm-9 col-xs-9 task-input-box">
                          <select class="form-control basic-detail-input-style apply-task-input" name="project" id="project">
                          @if(auth()->user()->id == 1 || auth()->user()->hasRole('MD'))
                ...
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-2 col-sm-3 col-xs-3 task-label-box">
                          <label class="apply-task-label">Department</label>
                      </div>
                      <div class="col-md-10 col-sm-9 col-xs-9 task-input-box">
                          <select class="form-control basic-detail-input-style apply-task-input" name="department" id="department">
                          @if(auth()->user()->id == 1 || auth()->user()->hasRole('MD')) 
                            <option value="0">All</option>
                          @endif   
              ...
              <div class="box-footer form-sidechange add-compensatory-btn">
                <button type="button" class="btn btn-primary" id="taskReportFormSubmit">Submit</button>
              </div>
            </form>
  ...
  <script type="text/javascript">
      ...
      $("#taskReportFormSubmit").click(function(){
        if(allowFormSubmit.date == 0){
          return false;

        }else if(allowFormSubmit.date == 1){
          $("#taskReportForm").submit();
