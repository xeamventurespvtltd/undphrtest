            ...
            <form id="stateForm" action="" method="POST">
              ...
              <div class="box-body">
                ...
                <div class="form-group add-department-form">
                  ...
                  <div class="mastertbl-department-input">
                    <input type="text" class="form-control basic-detail-input-style" id="cityName" name="name" placeholder="City Name" value="{{@$data['city']->name}}">
                  </div>
                </div>
              </div>
          ...
          <div class="row">
            <table id="listStates" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><a class="btn bg-purple" href='{{ route("employees.cities") }}/{{$value->id}}?state_id={{$value->state_id}}' title="edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;<!-- <a class="btn btn-danger deleteBtn" href='{{ url("/masterTables/states/delete/$value->s_id")}}'>Delete</a> --></td>
                </tr>
                @endforeach
