              ...
              <form id="filters" class="search-field-box" method="GET">
                  <div class="row select-detail-below">
                    ...
                    <div class="col-md-3 attendance-column4">
                        <div class="form-group">
                            <label>Company<sup class="ast">*</sup></label>
                            <select class="form-control input-sm basic-detail-input-style" name="company">
                                <option value="" disabled>Please select Company</option>
                                @if(!$data['companies']->isEmpty())
                                @foreach($data['companies'] as $company)
                                  <option value="{{$company->id}}" @if($company->id == $req['company']){{'selected'}}@endif>{{$company->name}}</option>
                                @endforeach  
                                @endif
                            </select>
                        </div>
                  ...
                  <div class="row select-detail-below2">
                    ...
                    <div class="col-md-3 attendance-column4">
                        <div class="form-group">
                            ...
                            <select class="form-control input-sm basic-detail-input-style" name="attendance_type" id="attendance_type">
                  ...
                  <div class="submit-btn-box">
                    ...
                    @if(!empty($req['submit']) && !$employees->isEmpty() && $data['isverified'] == 1)
                    <input type="submit" name="submit" value="export excel sheet" class="btn submit-btn"><i class="fa fa search"></i>

                    <input type="submit" name="submit" value="saral excel sheet" class="btn submit-btn"><i class="fa fa search"></i>
                    @endif
                  </div>
              </form>
                      ...
                      <table id="employeesList" class="table table-bordered table-striped hello">
                          <thead class="table-heading-style">
                              ...
                              <tr>
                                ...
                                <th class="text-center">Total Paid Days</th>
