    ...
    ?>
      ...
      <div class="three-icon-box">
		...
		<!--@endif -->
          ...
          ?>
          <div>  
          <a class="fc-day-grid-event fc-h-event fc-event fc-start fc-end fc-draggable calender-day-check-in @if(@$attendanceArray['late']){{'late_hide'}}@endif">
...
<script type="text/javascript">
  ...
  $(".verifyMonthAttendance").on('click',function(){
    ...
    var user_id = $(this).data('userid'); //30
    var manager_id = $(this).data('managerid'); //50
	return false;
