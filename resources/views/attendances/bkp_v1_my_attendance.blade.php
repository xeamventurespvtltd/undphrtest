...
<div class="fc-view-container" style="">
    ...
    <?php }else{ ?>
      ...
      <div class="three-icon-box">
          ...
          @endphp  
          <a {!! $anchorAttr !!} href="{!! $href !!}" class="fc-day-grid-event fc-h-event fc-event fc-start fc-end fc-draggable calender-day-check-in @if(@$attendanceArray['late']){{'late_hide'}}@endif">
